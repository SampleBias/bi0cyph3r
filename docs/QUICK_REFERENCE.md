...
1. Press `i` to write a message, or `Ctrl+O` to import a UTF-8 file.
...
No browser or server is used. See the [project README](../README.md) for CLI, Docker, data handling, and optional Solana instructions.
